...
to setup
  ...
  create-hawks 1 [set color red set size 2]
  reset-ticks
end
...
to hunting
  let nearest-flock max-one-of patches in-radius vision-hawk [count birds-here]
  ifelse count birds-on nearest-flock = 0 [roam][face nearest-flock]
end
  ...
  if any? flockmates
    [ find-nearest-neighbor
      ifelse distance nearest-neighbor < minimum-separation
        ...
        [ align
          cohere ] ]
  if any? hawks in-radius vision[
    face min-one-of hawks [distance myself]
    right 180]
end
